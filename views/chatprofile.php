...
<div style="margin-top: 20px;">
  <div class="container-fluid" style="width:800px; margin:0 auto; padding: 5px;">
    <article class="card-body">
      <div style="height:500px; border:1px solid #ccc; overflow-y: scroll; padding:16px; background-color: gray;" class="chat_history" id="a">
      ...
      <div class="form-group">
        <form action="" method="POST">
          ...
          <span>
          <input type="submit" id="send_msg" class="btn btn-outline-success" value="Send" name="send_button" data-id="<?=$this->to_id?>"/>
        </form>
      </div>
    </article>
  </div>
